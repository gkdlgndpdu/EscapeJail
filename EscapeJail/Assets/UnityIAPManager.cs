...
public class UnityIAPManager : MonoBehaviour, IStoreListener//(리스너는 결제후 호출될메시지때문에 있어야함)
{
    ...
    //결제 실패시 (취소버튼, 창 나갔을때) 결제실패 알림정도를 표시해주면 될듯
